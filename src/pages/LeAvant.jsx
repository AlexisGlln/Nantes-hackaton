...
const LeAvant = () => {
  return (
    ...
    <div className="avant-container">
      ...
      <p className="text-le-avant">Décider d'un commun accord des modalités de remplacement</p>
      <p className="text-le-avant">Participer au recrutement et à la formation du remplaçant</p>
      <p className="text-le-avant">
      ...
      <p className="text-le-avant">Contrôler et vérifier les modalités du retour de congé maternité</p>
      <p className="text-le-avant">
