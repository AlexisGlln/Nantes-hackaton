...
function LeRetour() {
  return (
    ...
    <div className='retour-container'> 
      ...
      <h4>1. Le droit de retrouver son poste :</h4> 
    ...
    <h3>2. L’entretien de retour de congé maternité :  </h3>
    <p>La salariée qui 
    ...
    <h3>3. La visite médicale de retour de congé maternité : </h3>
    ...
    <h3>4. La démission sans préavis : </h3>
    ...
    <h3>5. Le temps pour allaiter son enfant :</h3>
    ...
    <h3>6. La garantie de rattrapage salarial : </h3>
