  ...
  return (
    <div className="body-l-annonce">
      <div className="container-annonce">
        ...
        <h1 className="tilte-temoignages">
          Elles en parlent : <br />
          Témoignage - L’annonce de la grossesse est un premier moment délicat
          pour les femmes
        </h1>

        <div className="container-temoignage-annonce">
          <p className="temoignage-annonce">
            « On sait que ce n’est jamais le bon moment pour l’entreprise, ils
            sont choqués, on essaie de savoir ce qui se passe dans leur tête. »
          ...
          <p className="temoignage-annonce">
            « On sait que ce n’est jamais le bon moment pour l’entreprise, ils
            sont choqués, on essaie de savoir ce qui se passe dans leur tête. »
            Responsable financière, banque, 39 ans, 2 enfants « J’étais en lien
            avec la RH, plus qu’avec mon responsable direct, c’est à eux que
            j’ai annoncé ma grossesse, ce sont eux qui se sont mis en lien avec
            mes supérieurs, ça a calmé mon appréhension. »
          ...
          <p className="temoignage-annonce">
            ...
            inquiétez pas, je serai là, je ne vous lâcherai pas. »
            <strong> Consultante en recrutement, 31 ans, 1 enfant </strong>
          </p>

          <p className="temoignage-annonce">
            « Le début de la grossesse a été très difficile. J'ai intégré une
            équipe et un an plus tard je suis tombée enceinte. On m'a promue
            manager pour que je puisse appliquer mes méthodes de travail aux
            consultantes. Je n'avais encore rien dit à mon employeur mais, prise
            de panique et peur de ne pas pouvoir assumer toutes ces responsabilités, j'ai dû en parler rapidement pour ne pas promettre
            des choses et ne pas pouvoir les assumer durant mon congé maternité.
